...
const Apertura = () => {
    ...
    return (
        <div className="flex items-center justify-center h-[100vh] overflow-x-hidden relative">
            <div class="orange-blur"></div>
            <div class="orange-blur2 invisible lg:visible"></div>
            {/* <div class="orange-blur3"></div> */}
            <div className="flex flex-col justify-center px-8 sm:px-0 py-20 w-full sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[40%]">
                <div className="w-72 sm:w-96 my-10">
                    <Rifavo />
                </div>
                <h1 className="text-6xl font-bold">Llegaremos muy pronto</h1>
                <p className="mt-4 text-slate-500 text-lg">Queremos que tengas una buena experiencia usando nuestra plataforma así que estamos haciendo lo mejor para tener una plataforma que puedas usar facilmente</p>
                ...
                <div className="flex justify-between gap-5 mt-3">
                    <p className="text-slate-500">Mantente al tanto a través de nuestras redes sociales</p>
